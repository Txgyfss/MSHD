    ...
    <div style="display: flex">
      <el-form style="padding-left: 600px">
        <el-form-item class="form-box" style="padding-top: 50px;border-radius: 10px">
          ...
          <el-form-item >
            <el-input style="margin-bottom: 30px" size="large" show-password prefix-icon="el-icon-key" placeholder="请输入确认密码" v-model="form.nmm"></el-input>
          </el-form-item>
          <el-form-item >
          ...
          <el-form-item>
            <el-button style="width: 100%;height: 50px;background-color: #fdd85e;border-color: #fdd85e;color:white;font-size:20px;" size="large" @click="register">注册</el-button>
          </el-form-item>
        </el-form-item>
        <el-form-item style="background-color: #28a4fd; border-radius: 10px; display: flex; color: white; justify-content: center;align-items: center">
          <el-form-item class="regBox">
            <a href="javascript:void(0)" @click="navLogin">登录</a><span class="el-icon-right"></span>
          </el-form-item>
